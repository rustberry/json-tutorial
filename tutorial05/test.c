...
#define GET_ARRAY_ELEMENT(index) lept_get_array_element(&v, index)
...
static void test_parse_array() {
	...
	EXPECT_EQ_INT(LEPT_PARSE_OK, lept_parse(lept_get_array_element(&v, 0), "null"));

	EXPECT_EQ_INT(LEPT_FALSE, lept_get_type(lept_get_array_element(&v, 1)));
	EXPECT_EQ_INT(LEPT_PARSE_OK, lept_parse(GET_ARRAY_ELEMENT(1), "false"));
	EXPECT_EQ_INT(LEPT_TRUE, lept_get_type(lept_get_array_element(&v, 2)));
	EXPECT_EQ_INT(LEPT_PARSE_OK, lept_parse(GET_ARRAY_ELEMENT(2), "true"));
	EXPECT_EQ_INT(LEPT_NUMBER, lept_get_type(lept_get_array_element(&v, 3)));
	EXPECT_EQ_DOUBLE(123.0, lept_get_number(GET_ARRAY_ELEMENT(3)));
	EXPECT_EQ_INT(LEPT_STRING, lept_get_type(lept_get_array_element(&v, 4)));
	EXPECT_EQ_STRING("abc", lept_get_string(GET_ARRAY_ELEMENT(4)), lept_get_string_length(GET_ARRAY_ELEMENT(4)));
	lept_free(&v);
	...
	EXPECT_EQ_SIZE_T(3, lept_get_array_size(GET_ARRAY_ELEMENT(3)));
	lept_free(&v);
}
